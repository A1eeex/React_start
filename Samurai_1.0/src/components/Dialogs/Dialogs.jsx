...
const Dialogs = (props) => {
  ...
  let dialogsElement = props.dialogs.map(newDialog => <DialogItem id={newDialog.id} name={newDialog.name}/>)
  let messageElement = props.messages.map(newMessage => <Message message={newMessage.message}/>)
